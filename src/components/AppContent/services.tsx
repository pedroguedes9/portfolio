...
export const Services = ({currentLanguage}:ServicesProps) => {
    return (
        <div className="min-h-full w-full max-w-5xl mx-auto p-6 flex flex-col gap-4 select-text scroll-smooth  ">
            ...
            <div className="grid grid-cols-2 gap-4 p-5 content-center">
                {services.map(service => {
                    ...
                    return (
                        <div className="last:col-span-2 group flex flex-col gap-4 rounded-2xl min-h-37.5 border border-white/10 bg-white/5 p-5 backdrop-blur-xs hover:bg-white/7 hover:border-violet-300/25 hover:-translate-y-1 hover:shadow-lg hover:shadow-violet-500/10 transition-all" key={service.id}>
